                ...
                <div class="container">
                    ...
                    <div id="materialize-menu" class="menuzord">
                        ...
                        <a href="<?php echo base_url(); ?>" class="logo-brand">
                            <img src="<?php echo base_url(); ?>assets/img/Sekolahqu.png" alt=""/>
                        </a>
                        <!--logo end-->
                        ...
                        <ul class="menuzord-menu pull-right">
                            ...
                            <li><a href="<?php echo site_url('user')?>">Login</a>
                            </li>
                        </ul>
                        <!--mega menu end-->
         ...
         <div class="rev_slider materialize-slider">
          <ul>
            ...
            <li data-transition="fade" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="assets/img/banner/banner-1.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="materialize Material" data-description="">
                ...
                <!-- MAIN IMAGE -->
                <img src="<?php echo base_url(); ?>assets/img/banner/banner-1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                ...
                <div class="tp-caption rev-heading text-extrabold dark-text tp-resizeme"
                    ...
                    style="z-index: 5; white-space: nowrap;">Selamat Datang di SekolahQu
                </div>
                ...
                <div class="tp-caption tp-resizeme rev-subheading  dark-text text-center"
                    ...
                    data-splitout="none" 
                    data-responsive_offset="on"
                    style="z-index: 6; white-space: nowrap;">Ini adalah halaman utama. <br> untuk login silahkan tekan tombol "Login" di pojok kanan atas.
                </div>
...
<!--                    <a href="#" class="btn btn-lg sekolahqu waves-effect waves-light">Explore More</a>-->
                </div>
        ...
        <section class="section-padding">
            <div class="container">
                ...
                <div class="text-center mb-80">
                    <h2 class="section-title text-uppercase">Siapa Kita</h2>
                    <p class="section-sub">Kami adalah tim dari mahasiswa UNIKOM yang membuat aplikasi SekolahQu berbasis Android,</p>
                </div>
                            ...
                            <div class="panel-body mt-40">
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade" id="icontab-1">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h2 class="text-bold mb-40">Tentang Kita</h2>
                                                <p>Tim kami terdiri dari 5 anggota, yaitu Helsan Firmansyah, M. Rasyid Ridha, Yusri Sahrul, Yuka Pangestu, dan Annatsa Rahayu</p>
                                            </div>

                                            <div class="col-md-6">
                                                <img src="<?php echo base_url(); ?>assets/img/workstation.jpg" alt="image" class="img-responsive">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in active" id="icontab-2">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h2 class="text-bold mb-40">Misi Kita</h2>
                                            ...
                                            <div class="col-md-6">
                                                <img src="<?php echo base_url(); ?>assets/img/mission.jpg" alt="image" class="img-responsive">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="icontab-3">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h2 class="text-bold mb-40">Apa Yang Kita Lakukan</h2>
                                                <p>Himenaeos a vestibulum morbi. <a href="#">Ullamcorper cras scelerisque</a> taciti lorem metus feugiat est lacinia facilisis id nam leo condimentum praesent id diam. Vestibulum amet porta odio elementum convallis parturient tempor tortor tempus a mi ad parturient ad nulla mus amet in penatibus nascetur at vulputate euismod a est tristique scelerisque. Aliquet facilisis nisl vel vestibulum dignissim gravida ullamcorper hac quisque ad at nisl egestas adipiscing vel blandit.</p>
                                            </div>

                                            <div class="col-md-6">
                                                <img src="<?php echo base_url(); ?>assets/img/idea.jpg" alt="" class="img-responsive">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="icontab-4">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h2 class="text-bold mb-40">Langkah Kita</h2>
                                                <p>Himenaeos a vestibulum morbi. <a href="#">Ullamcorper cras scelerisque</a> taciti lorem metus feugiat est lacinia facilisis id nam leo condimentum praesent id diam. Vestibulum amet porta odio elementum convallis parturient tempor tortor tempus a mi ad parturient ad nulla mus amet in penatibus nascetur at vulputate euismod a est tristique scelerisque. Aliquet facilisis nisl vel vestibulum dignissim gravida ullamcorper hac quisque ad at nisl egestas adipiscing vel blandit.</p>
                                            </div>

                                            <div class="col-md-6">
                                                <img src="<?php echo base_url(); ?>assets/img/workstation2.jpg" alt="image" class="img-responsive">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="parallax-bg banner-5 bg-fixed overlay dark-5 padding-top-100" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="mb-80 text-center">
                    <h2 class="font-30 white-text text-extrabold text-uppercase">Demo Aplikasi SekolahQu</h2>
            ...
            <div class="mocup-wrapper text-center">
                <img src="<?php echo base_url(); ?>assets/img/mockup.png" alt="image">
            </div>
        </section>

        <footer class="footer footer-four">
            <div class="primary-footer sekolahqu text-center">
                <div class="container">

                  <div class="row">
                    <div class="col-md-12">
                          <div class="footer-logo">
                            <img src="<?php echo base_url(); ?>assets/img/sekolahqu2.png" alt="">
                          </div>
            ...
            <div class="secondary-footer sekolahqu darken-2 text-center">
                <div class="container">
                    <ul>
        ...
        <div id="preloader">
          <div class="preloader-position"> 
            <img src="<?php echo base_url(); ?>assets/img/Sekolahqu2.png" alt="logo" >
            <div class="progress">
        ...
        <script src="<?php echo base_url(); ?>assets/bootstrap2/js/bootstrap.min.js"></script>
